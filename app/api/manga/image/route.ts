...
export async function POST(request:Request){
  try{
    ...
    const media=await persistGeneratedImage({imageDataUrl:result.imageDataUrl,filename:`manga-${seed}.webp`,metadata:{type:"manga-image",seed,model:result.model,provider:result.provider}});
